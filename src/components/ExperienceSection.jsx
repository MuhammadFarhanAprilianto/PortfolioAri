...
export default function ExperienceSection() {
  ...
  const certifications = [
    ...
    },
    {
      ...
      year: '2025',
      badge: 'Sertifikasi K3 Kemnaker RI',
      image: '/K3_SERTIFIKASI.webp',
      file: '/Sertifikat K3 Umum Ari Supriyanto.pdf',
      desc: 'Pelatihan dan sertifikasi keahlian Keselamatan dan Kesehatan Kerja lingkungan industri, identifikasi potensi bahaya, audit SMK3, dan SOP kepatuhan APD pabrik.',
      tags: ['Ahli K3 Umum', 'Mita Training', 'Audit SMK3', 'Budaya 5S Industri'],
    },
    {
      id: 3,
